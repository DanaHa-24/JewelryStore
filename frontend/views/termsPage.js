$(document).ready(function() {
    ...
    $('<h1></h1>').text('תקנון האתר').appendTo(termsContainer);
    ...
    $('<h2></h2>').text('האימות האישי').appendTo(termsContainer);
    ...
    $('<h2></h2>').text('שימוש בתוכן').appendTo(termsContainer);
    ...
    $('<h2></h2>').text('מדיניות פרטיות').appendTo(termsContainer);
